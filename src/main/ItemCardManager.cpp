...
bool ItemCardManager::InstallHooks()
{
	...
	static REL::Relocation<std::uintptr_t> hook1{ Offset::ItemCard::ShowItemData, 0x11AB };
	static REL::Relocation<std::uintptr_t> hook2{ Offset::ItemCard::ShowItemData, 0x11BB };

	constexpr auto assembly = REL::make_pattern<"66 83 7F 20 00 75 16">();
